...
export const ROUTES = [
  ...
  },
  {
    ...
    h1: "Privacy Policy",
    description: "How AEO Improvement collects, uses, stores, shares, and deletes account, audit, analytics, and Google integration data. Effective September 2, 2026.",
    ogType: "website",
    ...
    staticSections: [
      ...
      { heading: "How we use Google data", body: "We use GA4 data to show traffic and engagement reporting, including visits referred by AI assistants and answer engines. We use Search Console data to show page and query performance, identify SEO opportunities, and compare observed changes over time inside your private account." },
  ...
  },
  {
    ...
    h1: "Google Data Use",
    description: "How AEO Improvement accesses, uses, stores, and deletes Google Analytics and Search Console data. Effective September 2, 2026.",
    ogType: "website",
    modifiedTime: "2026-09-02",
    legal: true,
    staticSections: [
      ...
      { heading: "Product use", body: "The product uses connected data to display GA4 traffic and engagement reporting, Search Console page and query performance, SEO opportunities, and observed changes over time inside the user's private account." },
