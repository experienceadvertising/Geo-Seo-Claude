...
export const ROUTES = [
  ...
  },
  {
    ...
    h1: "Privacy Policy",
    description: "How AEO Improvement collects, uses, stores, shares, and deletes account, audit, notification, analytics, and Google integration data. Updated September 6, 2026.",
    ogType: "website",
    ...
    staticSections: [
      ...
      { heading: "Browser notifications", body: "Browser notifications are optional and require an explicit permission choice in a supported browser. If enabled, we store the browser-provided push endpoint and encryption keys with your account to deliver important audit and monitoring updates, your next task, and one weekly strategy credited to a named authority source. A notification may include a short task or strategy title, but not page excerpts, audit scores, or search queries, and may appear on the device lock screen. You can turn notifications off from the browser where you enabled them." },
    ],
    jsonLd: [],
  },
  {
