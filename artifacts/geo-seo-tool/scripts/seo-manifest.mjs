...
export const ROUTES = [
  ...
  },
  {
    ...
    staticSections: [
      ...
      { heading: "Browser notifications", body: "Browser notifications are optional and require an explicit permission choice in a supported browser. If enabled, we store the browser-provided push endpoint and encryption keys with your account to deliver audit-ready and next-task updates. A notification may include a short recommendation title, but not page excerpts, audit scores, or search queries, and may appear on the device lock screen. You can turn notifications off from the browser where you enabled them." },
    ],
    jsonLd: [],
  },
  {
