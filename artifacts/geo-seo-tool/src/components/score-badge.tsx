...
export function ScoreBadge({ score, className = "" }: { score: number, className?: string }) {
  ...
  if (score >= 80) colorClass = "bg-green-500/10 text-green-500 border-green-500/20";
  else if (score >= 60) colorClass = "bg-yellow-500/10 text-yellow-600 border-yellow-500/20 dark:text-yellow-400";
