...
const PRICING_DESC =
  "Every feature free for your first month — no credit card. Then free AEO audits forever, or Pro from $79/mo for ChatGPT, Claude, Gemini, and Perplexity coverage plus the Fix Generator. Agency plan for multi-client teams.";
      ...
      <div className="max-w-5xl mx-auto space-y-12">
        <div className="text-center space-y-3">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            ...
            no credit card. After that, stay free or upgrade to keep all AI
            engines, automated fixes, and competitor intelligence.
          </p>
