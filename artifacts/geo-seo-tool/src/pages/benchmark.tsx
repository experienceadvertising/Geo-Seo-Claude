...
export default function Benchmark() {
  ...
  return (
    <article className="flex-1 bg-white text-slate-900">
      ...
      <header className="border-b bg-slate-950 text-white"><div className="mx-auto max-w-4xl px-5 py-16"><p className="text-emerald-300 text-sm font-semibold">Original, anonymized audit data</p><h1 className="mt-3 text-4xl md:text-5xl font-bold">2026 AI Citation Readiness Benchmark</h1><p className="mt-5 text-slate-300 text-lg max-w-2xl">A view of page signals we can measure, such as access, content, and schema. These gaps are worth checking, but a score cannot predict inclusion in an AI answer.</p><p className="mt-4 text-sm text-slate-400">Dataset version 2026.07. Scores are aggregated; URLs, brands, and users are not published.</p></div></header>
