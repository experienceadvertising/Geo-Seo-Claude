...
export const OUR_FACTS = {
  freeTier: "First month free with all core product features unlocked, then a free plan with 5 audits and 2 simulations per month, with no credit card",
  proPrice: "$79 / month or $750 / year",
  agencyPrice: "$249 / month or $2,390 / year",
